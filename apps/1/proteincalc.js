...
function proteincalculate (){
			...
			food1.innerHTML = "<span>g* include </span>";
			...
			food1.insertAdjacentHTML("beforeend", ` <span>of the daily protein requirement </span><span id='dailyrequirementingram'>(${dailyrequirementingram} g)</span>`);
